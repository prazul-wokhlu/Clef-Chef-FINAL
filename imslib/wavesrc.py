...
class WaveBuffer(object):
    ...
    @staticmethod
    def from_data(data, num_frames):
        """
        Creates a WaveBuffer from raw audio data (numpy array).
        
        :param data: A numpy array of raw audio data.
        :param num_frames: The number of frames in the audio data.
        
        :returns: An instance of WaveBuffer.
        """
        wave_buffer = WaveBuffer.__new__(WaveBuffer)  # Create an instance without calling __init__
        wave_buffer.data = data
        wave_buffer.num_channels = 2  # Assuming stereo
        return wave_buffer
